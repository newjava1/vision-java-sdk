...
//                TypeDecoder.instantiateType("bytes", testbytes), (new DynamicBytes(testbytes)));
    ...
    @Test
    public void testVrcToken() throws Exception {
        assertEquals(
                TypeDecoder.instantiateType(
                        "vrcToken", "00000000000000000000000000000000000000000000000000000000000f4e0c"),
                (new VrcToken(1003020)));
    }
    ...
    public void testStaticArray() throws Exception {
        ...
        Assertions.assertEquals(staticArray2.getComponentType(), Uint256.class);

        Assertions.assertEquals(staticArray2.getValue().get(0), (new Uint256(BigInteger.TEN)));
